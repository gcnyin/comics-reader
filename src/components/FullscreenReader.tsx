...
export default function FullscreenReader({
  ...
  return (
    <div ref={readerRef} className="fullscreen-reader" onWheel={handleWheel}>
      <div
        className={`reader-controls ${isControlsVisible ? 'visible' : 'hidden'}`}
      >
        <button
          onClick={isRightToLeft ? navigateNext : navigatePrev}
        ...
        <button
          onClick={isRightToLeft ? navigatePrev : navigateNext}
